...
public final class Complex1 extends Number
implements java.io.Serializable, Cloneable, Comparable
{
    ...
    /**
     *	Compares with another Complex. <p><em>Note: To be useful in hashtables this method
     * considers two NaN double values to be equal. This is not according to IEEE specification.</em>
    ...
    {
        return (Math.abs(re - z.re) < Double.MIN_VALUE * 2
        && Math.abs(im - z.im) < Double.MIN_VALUE * 2);
    }
