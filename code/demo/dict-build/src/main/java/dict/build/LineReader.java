...
/**
 * Efficient reader for data that consists of text lines, i.e. character data
 * separated by one of standard line feeds (CR, LF or CR+LF). For efficiency no
 * decoding is done
 */
public class LineReader extends DataReader<String> {
	...
	/**
	 * Convenience method for instantiating factory to create instances of this
	 * {@link DataReader}.
	 */
	...
	public static class Factory extends DataReaderFactory<String> {
		@Override
