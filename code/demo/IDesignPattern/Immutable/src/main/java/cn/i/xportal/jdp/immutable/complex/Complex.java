...
public final class Complex extends Number implements java.io.Serializable, Cloneable, Comparable {
	...
	public boolean equals(Complex z) {
		return (Math.abs(re - z.real()) < Double.MIN_VALUE * 2) && (Math.abs(im - z.image()) < Double.MIN_VALUE * 2);
	}
