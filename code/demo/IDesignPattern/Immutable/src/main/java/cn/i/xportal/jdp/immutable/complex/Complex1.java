package cn.i.xportal.jdp.immutable.complex;

public final class Complex1 extends Number implements java.io.Serializable, Cloneable, Comparable {
	/** The imaginary unit. */
	private static final Complex1 i = new Complex1(0.0, 1.0);
	...
	private static String suffix = "i";
	 ...
	 * <p>
	 * <em>Note: To be useful in hashtables this method considers two NaN double
	 * values to be equal. This is not according to IEEE specification.</em>
	 * 
	 * @param z
	 *            A Complex object.
	...
	public boolean equals(Complex1 z) {
		return (Math.abs(re - z.re) < Double.MIN_VALUE * 2 && Math.abs(im - z.im) < Double.MIN_VALUE * 2);
	}
	...
	/**
	 * Compares this Complex to another Object. If the Object is a Complex, this
	 * function behaves like compareTo(Complex). Otherwise, it throws a
	 * ClassCastException (as Complex objects are comparable only to other
	 * Complex objects).
	 */
	 ...
	 * <P>
	 * A lexagraphical ordering is used. First the real parts are compared in
	 * the sense of Double.compareTo. If the real parts are unequal this is the
	 * return value. If the return parts are equal then the comparison of the
	 * imaginary parts is returned.
	 * 
	 * @return The value 0 if z is equal to this Complex; a value less than 0 if
	 *         this Complex is less than z; and a value greater than 0 if this
	 *         Complex is greater than z.
	 */
	...
	/**
	 * Returns the product of a Complex object and a pure imaginary double, x *
	 * iy.
	 * 
	 * @param x
	 *            A Complex object.
	 * @param y
	 *            A pure imaginary, double value.
	...
	/**
	 * Returns the product of a pure imaginary double and a Complex object and a
	 * , ix * y.
	 * 
	 * @param x
	 *            A pure imaginary, double value.
	...
	public String toString() {
		...
		if (Math.abs(re) < Double.MIN_VALUE * 2) {
