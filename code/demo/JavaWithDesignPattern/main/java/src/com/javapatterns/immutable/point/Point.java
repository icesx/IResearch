...
public class Point implements java.io.Serializable
{
    ...
    /**
     * Changes the point to have the specificed location. <p> This method is included for completeness, to parallel the
     * <code>setLocation</code> method of <code>Component</code>.
    ...
    /**
     * Moves this point to the specificed location in the (<i>x</i>,&nbsp;<i>y</i>) coordinate plane. This method
     ...
     * along the <i>y</i> axis so that it now represents the point (<code>x</code>&nbsp;<code>+</code>&nbsp;<code>dx</code>,
